		...
		<div class="row">
			<div class="col-sm-4">
				...
				<select name="searchCondition" class="form-control">
					...
					<option value="TW" ${searchCondition eq 'TW' ? 'selected' : '' } >작성일시</option>
				</select>
			</div>
			<div class="col-sm-6">
...
<nav aria-label="Page navigation example">
   <ul class="pagination justify-content-center">
      ...
      <li class="page-item">
      <a class="page-link" href="boardList.do?page=${p }&searchCondition=${searchCondition }&keyword=${keyword }" aria-label="Next">
